<template>
  <section class="bg-primary py-8">
    <div class="container mx-auto">
      ...
      <p class="text-dark mt-5 text-center">
        Are these reasons enough to convince you to invest in influencer marketing? They should be.
      </p>
      <p class="text-dark mt-5 text-center">
        While marketers started leveraging the power of influence with celebrities, micro-influencer
        collaborations are rising in popularity.
      </p>
    </div>
  </section>
</template>
