      ...
      <div class="guarantee-wrapper md:flex justify-between md:mx-32 text-center pb-12">
        ...
        <div class="mb-20 md:mb-0">
          ...
          <p class="text-gray text-gray mt-3">
            ...
            transformational change for each client
          </p>
        </div>
        <div>
          <h1 class="text-white font-bold text-xl">Value</h1>
          <p class="text-gray text-gray mt-3">Two words. <em> Affordable investment</em>.</p>
        </div>
      </div>
    </div>
  </div>
